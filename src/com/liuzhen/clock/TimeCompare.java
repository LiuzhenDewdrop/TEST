...
public class TimeCompare {
	...
	public static void main(String args[]) throws AssertionError, ParseException {
		...
		compareDatesByCompareTo(df, df.parse("2012-01-01"), df.parse("2012-01-01"));
		compareDatesByCompareTo(df, df.parse("2012-02-03"), df.parse("2012-04-05"));
		compareDatesByCompareTo(df, df.parse("2012-02-03"), df.parse("2012-01-02"));
		...
		compareDatesByDateMethods(df, df.parse("2012-01-01"), df.parse("2012-01-01"));
		compareDatesByDateMethods(df, df.parse("2012-02-03"), df.parse("2012-04-05"));
		compareDatesByDateMethods(df, df.parse("2012-02-03"), df.parse("2012-01-01"));
		...
		compareDatesByCalendarMethods(df, df.parse("2012-01-01"), df.parse("2012-01-01"));
		compareDatesByCalendarMethods(df, df.parse("2012-02-03"), df.parse("2012-04-05"));
		compareDatesByCalendarMethods(df, df.parse("2012-02-03"), df.parse("2012-01-01"));
	}
