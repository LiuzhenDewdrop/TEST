...
public class RomantoInteger_13 {
	...
	public static void main(String[] args) {
		LeetCodeUtil.test(test001("III"), 3);
		LeetCodeUtil.test(test001("IV"), 4);
		LeetCodeUtil.test(test001("IX"), 9);
		LeetCodeUtil.test(test001("LVIII"), 58);
		LeetCodeUtil.test(test001("MCMXCIV"), 1994);
	}
